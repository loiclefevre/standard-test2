...
export INFO=$(curl -s -k -L -X GET "https://api.testpilotdev-controller.oraclecloud.com/ords/testpilot/admin/database?type=autonomous" -H 'accept: application/json')
